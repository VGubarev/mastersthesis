...
# example data
lf1data = genfromtxt("data/lf/sc_se_latency")
lf2data = genfromtxt("data/lf/se_sc_latency")

print (np.quantile(lf1data, [0.5, 0.8, 0.9, 0.95, 0.99]))
print (np.quantile(lf2data, [0.5, 0.8, 0.9, 0.95, 0.99]))
