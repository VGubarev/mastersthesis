...
np.append(enginedata, genfromtxt("data/hsha/se_latency"))
np.append(enginedata, genfromtxt("data/tcp/se_latency"))
...
ax.set_xlabel('Временная задержка на обработку заявки во процессе №1, мкс')
